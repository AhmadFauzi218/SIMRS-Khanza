        ...
        if (connection == null) {
            try {
                ...
                System.out.println("  Koneksi Berhasil. Sorry bro loading, silahkan baca dulu.... \n\n"
                        ...
                        + "  #                                                                           \n"
                        + "                                                                           \n"
                        + "  MODIFIKASI IT RSU KHALISHAH                                             \n"
                        + "#                                                                           \n"
//                        + "# Tambahan dari Modifikasi IT RSU KHALISHAH:                                  \n"
//                        + "#                                                                           \n"
//                        + "# - Ganti Theme Warna SIMRS KHANZA                                                                          \n"
//                        + "# - Penambahan cetakan jam pakai obat di cetakan Penjualan Obat,Eticket Racikan,Umum.                             \n"
//                        + "# - Penambahan data expire obat di cetakan dan aplikasi.                    \n"
//                        + "#                                                                           \n"
                        + "# Catatan: Modifikasi ini dibuat untuk meningkatkan fungsionalitas aplikasi  \n"
                        + "# sesuai kebutuhan RSU Khalishah.   \n"
                        + "#                                                                           \n"
